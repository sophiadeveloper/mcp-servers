...
- **Advanced Iteration (Anthropic Guide)**: See [references/anthropic-guide.md](references/anthropic-guide.md) for official Anthropic principles on evaluation loops and description optimization.
